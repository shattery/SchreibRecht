    ...
    <header className="bg-dark/80 dark:bg-light/80 backdrop-blur-lg fixed top-0 left-0 w-full z-10">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-2 px-2">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-8">
          ...
          <div className="group">
            <a href="/uebung" className="block rounded-lg text-xl group font-semibold text-secondary hover:text-primary transition dark:text-dark dark:hover:text-primarydark">
              Übungen
            </a>
            <div className="bg-primary h-[1px] w-0 group-hover:w-full transition-all duration-500 ease-in-out"></div>
          </div>
      ...
      {isOpen && (
        <div className="lg:hidden p-4 bg-dark/80 dark:bg-light/80 backdrop-blur-lg">
          <PopoverGroup>
            ...
            <div className="group">
              <a href="/uebung" className="block rounded-lg text-3xl group font-semibold text-secondary hover:text-primary transition dark:text-dark dark:hover:text-primarydark">
                Test
                <div className="bg-primary h-[1px] w-0 group-hover:w-full transition-all duration-500 ease-in-out"></div>
              </a>
            </div>
